export const managerData = [3910, 3706, 2850, 4005, 3750, 2912, 3200, 3645, 4205, 3211, 3354, 3904];
...
export const managerQuarterData = [500, 390, 670, 600, 780, 440, 600, 680, 550, 475, 700, 795];
